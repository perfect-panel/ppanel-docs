...
- Redis 6.0+ (empfohlen: 7.0)

#### Binäre Installation

1. Bestimmen Sie die Systemarchitektur und laden Sie die entsprechenden Binärdateien herunter.
...
6. Wenn die Konfigurationsdatei leer oder nicht vorhanden ist, wird der Dienst mit der Standardkonfiguration gestartet. Der Pfad zur Konfigurationsdatei lautet: `./etc/ppanel.yaml`. Bitte initialisieren Sie die Systemkonfiguration über `http://Serveradresse:8080/init`.
