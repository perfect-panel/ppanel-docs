...
1. Sistem mimarisini belirleyin ve uygun ikili dosyayı indirin.
...
2. systemd hizmeti:
   ...
   - Hizmeti başlatma komutu: systemctl start ppanel
...
5. Hizmet günlüklerini görüntülemek için `journalctl -u ppanel -f` komutunu kullanabilirsiniz.
...
- Gereksinim: **ngx_http_realip_module** modülü, nginx -V komutunu kullanarak nginx'in bu modülü derleyip derlemediğini kontrol edin, eğer yoksa kendiniz derlemeniz gerekecek.

```nginx
    # cloudflare Başlangıcı
