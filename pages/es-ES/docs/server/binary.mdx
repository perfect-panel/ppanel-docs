...
4. Registro del servicio: el registro del servicio se guarda por defecto en el archivo /usr/local/bin/ppanel.log

5. Se puede ver el registro del servicio usando `journalctl -u ppanel -f`
