...
1. **Crea el archivo de configuración necesario**: Primero, crea y configura manualmente el archivo `/app/etc/ppanel.yaml` para la configuración posterior.
...
Antes de comenzar el despliegue de Docker Compose, primero crea y configura manualmente el archivo `/app/etc/ppanel.yaml` para asegurar el correcto funcionamiento del sistema. Para ejemplos detallados de las opciones de configuración, consulta la sección [Ejemplo de Opciones de Configuración](#ejemplo-de-opciones-de-configuración) de la documentación.
