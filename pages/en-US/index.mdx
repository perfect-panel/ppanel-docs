      ...
      <div className="container relative mx-auto max-w-[90rem] px-6">
        ...
        <div className="relative flex justify-between gap-16">
          <div className="w-full max-w-96 shrink-0 justify-between">
            ...
            <p className="text text-muted-foreground">
             PPanel is a pure, professional, and perfect open-source proxy panel tool,
             designed to be your ideal choice for learning and practical use.
            </p>
            <p className="flex gap-2 mt-4">
              ...
              <Link href="https://github.com/perfect-panel" className={cn(buttonVariants({
                variant: "secondary"
              }))}>
                Github
              </Link>
        ...
        <div className="relative mt-8 grid md:grid-cols-3">
          <div className="flex flex-col gap-y-6 px-2 py-10 md:p-6 lg:p-8">
            <SwatchBook />
            <div>
              <h3 className="text-lg font-medium">Multiprotocol</h3>
              <p className="mt-1 text-sm text-muted-foreground">
                Support a variety of encryption protocol management, such as: shadowsocks, v2ray, trojan, etc.
              </p>
            </div>
          </div>
          <div className="flex flex-col gap-y-6 px-2 py-10 md:p-6 lg:p-8">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                No user logs are stored, guaranteeing user privacy and security at the same time.
              </p>
            </div>
          </div>
          <div className="flex flex-col gap-y-6 px-2 py-10 md:p-6 lg:p-8">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                The minimalist design ensures that the product is easy to use while maintaining business logic.
              </p>
            </div>
          </div>
