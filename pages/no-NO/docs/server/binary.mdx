...
- Mysql 5.7+ (anbefalt å bruke 8.0)
- Redis 6.0+ (anbefalt å bruke 7.0)

#### Binær installasjon

1. Bestem systemarkitektur og last ned de tilsvarende binærfilene
...
1. Installeringsti: Binærfilene vil bli pakket ut til /root/ppanel-server-linux-amd64 katalogen
...
6. Når konfigurasjonsfilen er tom eller ikke eksisterer, vil tjenesten starte med standardkonfigurasjon, konfigurasjonsfilens sti er: `./etc/ppanel.yaml`,
