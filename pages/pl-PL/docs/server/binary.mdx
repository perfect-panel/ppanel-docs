...
1. Określ architekturę systemu i pobierz odpowiednie pliki binarne
...
1. Ścieżka instalacji: pliki binarne zostaną rozpakowane do katalogu /root/ppanel-server-linux-amd64
...
- Wymagana zależność: **ngx_http_realip_module**, użyj komendy nginx -V, aby sprawdzić, czy Nginx został skompilowany z tym modułem; jeśli nie, musisz go skompilować samodzielnie.
