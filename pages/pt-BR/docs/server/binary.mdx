...
Se você estiver usando o serviço de proxy Cloudflare, precisará obter o IP real do usuário. Por favor, adicione ao bloco Http do arquivo de configuração do Nginx:
