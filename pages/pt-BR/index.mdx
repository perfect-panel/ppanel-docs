    ...
    <div className="relative flex justify-between gap-16"> 
      <div className="w-full max-w-96 shrink-0 justify-between"> 
        ...
        <p className="text text-muted-foreground">
          O PPanel é uma ferramenta de painel de proxy open-source, pura, profissional e perfeita, projetada para ser a escolha ideal para seu aprendizado e prática. 
        </p> 
