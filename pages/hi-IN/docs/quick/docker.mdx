...
>
> - **प्रबंधन पोर्ट डिफ़ॉल्ट रूप से 8080 है**: कृपया पहले से डोमेन नाम का समाधान करें या सुनिश्चित करें कि एक उपलब्ध IP पता है, ताकि प्रबंधन और उपयोगकर्ता端 की स्थापना सुचारू रूप से हो सके।
