...
Docker 배포를 시작하기 전에, 먼저 수동으로 `/app/etc/ppanel.yaml`을 생성하고 구성하여 시스템이 정상적으로 작동하도록 합니다. 자세한 구성 항목 예시는 문서의 [구성 항목 예시](#구성항목예시) 부분을 참조하세요.
...
Docker Compose 배포를 시작하기 전에, 먼저 수동으로 `/app/etc/ppanel.yaml`을 생성하고 구성하여 시스템이 정상적으로 작동하도록 합니다. 자세한 구성 항목 예시는 문서의 [구성 항목 예시](#구성항목예시) 부분을 참조하세요.
