...
1. تعیین معماری سیستم و دانلود فایل باینری مربوطه
...
اگر از خدمات پروکسی Cloudflare استفاده می‌کنید، باید IP واقعی کاربر را دریافت کنید. لطفاً در بخش Http فایل پیکربندی Nginx موارد زیر را اضافه کنید:
