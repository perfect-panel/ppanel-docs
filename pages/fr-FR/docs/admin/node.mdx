...
Créez le fichier `apps/admin/.env` et ajoutez les variables d'environnement nécessaires (référez-vous à la configuration des variables d'environnement ci-dessus).
