...
# Rediger config, vennligst se konfigurasjonsalternativene, lagre og fortsett
...
ConnetionConfig:
  ...
  UplinkOnly: 2 # Tidsgrense når tilkoblingen nedstrøms er stengt, sekunder
  DownlinkOnly: 4 # Tidsgrense når tilkoblingen lukkes etter at oppstrøms er stengt, sekunder
  BufferSize: 64 # Den interne cache-størrelsen for hver forbindelse, kB
Nodes:
  - PanelType: 'PPanel' # Paneltype: PPanel, SSpanel, V2board, NewV2board, PMpanel, Proxypanel, V2RaySocks
    ...
    ControllerConfig:
      ...
      CertConfig:
        CertMode: dns # Alternativ om hvordan man får sertifikat: none, file, http, dns. Velg "none" for å tvinge deaktivere tls-konfigurasjonen.
