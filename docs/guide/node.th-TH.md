  ...
  - PanelType: 'PPanel' # ประเภทแผง: PPanel, SSpanel, V2board, NewV2board, PMpanel, Proxypanel, V2RaySocks
    ...
    ControllerConfig:
      ...
      CertConfig:
        ...
        Provider: alidns # ผู้ให้บริการใบรับรอง DNS, รับรายการสนับสนุนทั้งหมดที่นี่: https://go-acme.github.io/lego/dns/
        Email: test@me.com
        DNSEnv: # ตัวเลือก ENV DNS ที่ใช้โดยผู้ให้บริการ DNS
