...
Nodes:
  - PanelType: 'PPanel' # Panel türü: PPanel, SSpanel, V2board, NewV2board, PMpanel, Proxypanel, V2RaySocks
    ApiConfig:
      ...
      RuleListPath: # /etc/XrayR/rulelist Yerel kural listesi dosyası yolu
    ControllerConfig:
      ...
      FallBackConfigs: # Birden fazla geri dönüşü destekler
        - SNI: # TLS SNI (Sunucu Adı Belirtimi), herhangi bir şey için boş
          ...
          Dest: 80 # Gerekli, geri dönüşün hedefi, ayrıntılar için https://xtls.github.io/config/fallback/ adresine bakın.
          ProxyProtocolVer: 0 # PROXY protokol sürümünü gönder, 0 devre dışı bırak
      CertConfig:
        ...
        CertDomain: 'node1.test.com' # Sertifika için alan
