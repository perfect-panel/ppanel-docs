...
# A config szerkesztése, kérjük, nézze meg a konfigurációs elemeket, mentse el, majd folytassa
...
Nodes:
  - PanelType: 'PPanel' # Panel típusa: PPanel, SSpanel, V2board, NewV2board, PMpanel, Proxypanel, V2RaySocks
    ApiConfig:
      ...
      ApiKey: '123'
      NodeID: 41
      NodeType: V2ray # Node típusa: V2ray, Shadowsocks, Trojan
    ...
    ControllerConfig:
      ...
      FallBackConfigs: # Támogatja a több visszaállítást
        - SNI: # TLS SNI (Server Name Indication), üres bármilyen esetén
          Path: # HTTP PATH, üres bármilyen esetén
